<template>
    <v-expansion-panels multiple dark>
            <v-expansion-panel>
                <v-expansion-panel-header>Number of Unique Artists</v-expansion-panel-header>
            ...
            <v-expansion-panel>
                <v-expansion-panel-header>Music Mood</v-expansion-panel-header>
                <v-expansion-panel-content>
                    <apexchart :height="$vuetify.breakpoint.xs ? 350 : 600" width="100%" type="scatter" :options="chartOptionsScatter" :series="seriesScatter"></apexchart>
                </v-expansion-panel-content>
            </v-expansion-panel>
            ...
            <v-expansion-panel>
                <v-expansion-panel-header>Top 3 Music Attributes With Color coded</v-expansion-panel-header>
                <v-expansion-panel-content>
                    <apexchart :height="$vuetify.breakpoint.xs ? 350 : 600" width="100%" type="scatter" :options="chartOptionsScatter" :series="seriesScatter"></apexchart>
                </v-expansion-panel-content>
            </v-expansion-panel>
